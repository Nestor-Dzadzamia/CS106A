...
public class NameSurferGraph extends GCanvas
	...
	private ArrayList<NameSurferEntry> entryList; // here we create list to save Entries that have been made.
	private Color red;
	private Color blue;
	...
	*/
	public NameSurferGraph() {
		...
		entryList = new ArrayList<NameSurferEntry>(); // we initalizize variables in constructor
		red = Color.RED;
		blue = Color.BLUE;
		yellow = Color.YELLOW;
	}
	...
	*/
	...
	private void drawCurrentEntry(int colorType, NameSurferEntry e, int fontSize) {
		int rankCount = 0;
